...
spec template format. Not yet: multi-transaction interchanges, arbitrary
spec formats, partner-specific overrides, cross-transaction pairing
(e.g. 844/849). The layering above is built so those grow without rework
